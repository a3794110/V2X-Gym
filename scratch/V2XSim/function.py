...
# =============================================================================
def Vehicle_Position_List(Vehicle, PositionList):
    ...
    for i in range( len(getIDList)):
        PositionList[int(getIDList[i])*3] = traci.vehicle.getPosition(getIDList[i])[0]
        PositionList[int(getIDList[i])*3+1] = traci.vehicle.getPosition(getIDList[i])[1]
    return PositionList
