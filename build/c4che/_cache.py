...
CFLAGS_PYEMBED = ['-g', '-fwrapv', '-O2', '-g', '-fstack-protector-strong', '-g', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects']
CFLAGS_PYEXT = ['-g', '-fwrapv', '-O2', '-g', '-fstack-protector-strong', '-g', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects']
CFLAGS_cshlib = ['-fPIC']
COMPILER_CC = 'gcc'
COMPILER_CXX = 'g++'
CPPPATH_ST = '-I%s'
...
CXXFLAGS_PYEXT = ['-g', '-fwrapv', '-O2', '-g', '-fstack-protector-strong', '-g', '-flto', '-fuse-linker-plugin', '-ffat-lto-objects', '-fvisibility=hidden', '-Wno-array-bounds']
...
DEFINES = ['NS3_BUILD_PROFILE_DEBUG', 'NS3_ASSERT_ENABLE', 'NS3_LOG_ENABLE', 'HAVE_SYS_IOCTL_H=1', 'HAVE_IF_NETS_H=1', 'HAVE_NET_ETHERNET_H=1', 'HAVE_PACKET_H=1', 'HAVE_ZMQ=1', 'HAVE_PROTOBUF=1', 'HAVE_SQLITE3=1', 'HAVE_IF_TUN_H=1']
DEFINES_PYEMBED = ['NDEBUG']
DEFINES_PYEXT = ['NDEBUG']
DEFINES_ST = '-D%s'
DEFINE_COMMENTS = {'HAVE_INTTYPES_H': '', 'HAVE_PYTHON_H': '', 'HAVE_ZMQ': '', 'HAVE_SIGNAL_H': '', 'HAVE_NET_ETHERNET_H': '', 'HAVE_PACKET_H': '', 'HAVE_SYS_STAT_H': '', 'HAVE_IF_NETS_H': '', 'HAVE_RT': '', 'HAVE_SYS_INT_TYPES_H': '', 'HAVE_SYS_IOCTL_H': '', 'PYTHONARCHDIR': '', 'HAVE_STDLIB_H': '', 'HAVE_IF_TUN_H': '', 'HAVE_SQLITE3': '', 'INT64X64_USE_128': '', 'HAVE_LIBXML2': '', 'HAVE_UINT128_T': '', 'HAVE_SYS_TYPES_H': '', 'HAVE_STDINT_H': '', 'PYTHONDIR': '', 'HAVE___UINT128_T': '', 'HAVE_PYEMBED': '', 'HAVE_DIRENT_H': '', 'HAVE_PROTOBUF': '', 'HAVE_GETENV': '', 'HAVE_PYEXT': '', 'HAVE_PTHREAD_H': ''}
DEST_BINFMT = 'elf'
DEST_CPU = 'x86_64'
DEST_OS = 'linux'
...
ENABLE_ZMQ = True
EXAMPLE_DIRECTORIES = ['udp', 'naming', 'error-model', 'realtime', 'socket', 'traffic-control', 'tcp', 'ipv6', 'wireless', 'routing', 'energy', 'stats', 'matrix-topology', 'udp-client-server', 'tutorial']
...
INCLUDES_PYEMBED = ['/home/hank/env01/include/python3.5m']
INCLUDES_PYEXT = ['/home/hank/env01/include/python3.5m']
...
PYO = 1
PYTAG = 'cpython-35'
PYTHON = ['/home/hank/env01/bin/python']
PYTHONARCHDIR = '/usr/local/lib/python3.5/site-packages'
PYTHONDIR = '/usr/local/lib/python3.5/site-packages'
PYTHON_CONFIG = ['/home/hank/env01/bin/python-config']
PYTHON_VERSION = '3.5'
